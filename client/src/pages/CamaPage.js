...
import InsertCamaForm from "../components/CamaPage/insertCamaForm";
...
const CamaPage = () => {
  ...
  useEffect(() => {
    ...
    ws.onmessage = (event) => {
      ...
      const filteredArray = datosParse.data.filter(subArray => subArray.includes(window.localStorage.getItem("Hospital")));
      setUsers(filteredArray)
    };

    const ws2 = new WebSocket("ws://localhost:666/websocket/especialidad");
    setSocket2(ws2);
    ws2.onopen = () => {
